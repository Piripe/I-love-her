...
export default async function init() {
    ...
    if (conn) {
        ...
        await conn.execute("CREATE TABLE IF NOT EXISTS incoming_fallback (id INT PRIMARY KEY AUTO_INCREMENT, priority INT NOT NULL DEFAULT 0, color CHAR(6) CHARACTER SET ASCII NOT NULL DEFAULT 'aa2288', page JSON CHECK(JSON_VALID(page)))");
